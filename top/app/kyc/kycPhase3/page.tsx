...
const ffmpeg = createFFmpeg({ log: true }); // Initialize ffmpeg instance
...
const VideoCapture: React.FC = () => {
  ...
  const compressVideo = async (inputBlob: Blob) => {
    ...
    ffmpeg.FS("writeFile", "input.webm", await fetchFile(inputBlob)); // Write the file to memory
...
// import IsMobile from "../../components/IsMobile";
// import "../../styles/VideoCapture.css"; // Add this for custom styling
// import * as FFmpeg from "@ffmpeg/ffmpeg"; // Use the alternative import syntax
